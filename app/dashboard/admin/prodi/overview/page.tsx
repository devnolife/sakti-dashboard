...
export default function ProdiOverviewPage() {
  ...
  const fetchProdiOverview = async () => {
    try {
      ...
      const response = await apiGet('/api/admin/prodi/overview')
      ...
      console.log('Setting prodiList to:', prodiData)
  ...
  const totalStats = Array.isArray(prodiList) && prodiList.length > 0 ? {
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <div className="w-16 h-16 mx-auto mb-4 border-4 rounded-full animate-spin border-primary border-t-transparent" />
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold">Belum Ada Data Prodi</h3>
            <p className="mb-4 text-muted-foreground">
              Data program studi belum tersedia atau terjadi kesalahan saat memuat data.
              <br />
              Silakan refresh atau hubungi administrator jika masalah berlanjut.
            </p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            onClick={() => router.push('/dashboard/admin/super')}
          >
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-3">
                  {Array.isArray(prodiList) && prodiList.map((prodi) => (
                    <div key={prodi.id} className="p-4 border rounded-lg">
