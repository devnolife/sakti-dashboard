    ...
    children: [
      {
        ...
        href: "/dashboard/admin/view/mahasiswa",
        icon: Users,
      },
      {
        id: "dosen-view",
        title: "View Dosen",
        href: "/dashboard/admin/view/dosen",
        icon: GraduationCapIcon,
      },
      {
        id: "staff-view",
        title: "View Staff TU",
        href: "/dashboard/admin/view/staff-tu",
        icon: ClipboardList,
      },
      {
        id: "dekan-view",
        title: "View Dekan",
        href: "/dashboard/admin/view/dekan",
        icon: Crown,
      },
      {
        id: "prodi-view",
        title: "View Prodi",
        href: "/dashboard/admin/view/prodi",
        icon: BookOpen,
      },
      {
        id: "keuangan-view",
        title: "View Admin Keuangan",
        href: "/dashboard/admin/view/keuangan",
        icon: DollarSign,
      },
      {
        id: "lab-view",
        title: "View Lab Admin",
        href: "/dashboard/admin/view/laboratory",
        icon: FlaskConical,
      },
      {
        id: "library-view",
        title: "View Perpustakaan",
        href: "/dashboard/admin/view/library",
        icon: BookMarked,
      },
    ],
  },
    ...
    children: [
      {
        ...
        href: "/dashboard/admin/logs/user-activities",
        icon: Users,
      },
      {
        id: "kkp-activities",
        title: "Aktivitas KKP",
        href: "/dashboard/admin/logs/kkp",
        icon: Briefcase,
      },
      {
        id: "exam-activities",
        title: "Aktivitas Ujian",
        href: "/dashboard/admin/logs/exams",
        icon: GraduationCapIcon,
      },
      {
        id: "payment-activities",
        title: "Aktivitas Pembayaran",
        href: "/dashboard/admin/logs/payments",
        icon: CreditCard,
      },
      {
        id: "system-logs",
        title: "Log Sistem",
        href: "/dashboard/admin/logs/system",
        icon: Server,
      },
    ],
  },
    ...
    children: [
      {
        ...
        href: "/dashboard/admin/config/general",
        icon: Settings,
      },
      {
        id: "academic-config",
      ...
      },
      {
        ...
        href: "/dashboard/admin/config/email",
        icon: Mail,
      },
      {
        id: "role-permissions",
        title: "Hak Akses Role",
        href: "/dashboard/admin/config/permissions",
        icon: Shield,
      },
    ],
  },
    ...
    children: [
      {
        ...
        href: "/dashboard/admin/maintenance/backup",
        icon: Database,
      },
      {
        id: "restore",
        title: "Restore Database",
        href: "/dashboard/admin/maintenance/restore",
        icon: Database,
      },
      {
        id: "cache-management",
        title: "Kelola Cache",
        href: "/dashboard/admin/maintenance/cache",
        icon: Server,
      },
      {
        id: "system-health",
        title: "Kesehatan Sistem",
        href: "/dashboard/admin/maintenance/health",
        icon: Activity,
      },
    ],
  },
