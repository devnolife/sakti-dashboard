        ...
        <div className="relative w-full h-full p-6">
          ...
          {!showBack ? (
            ...
            <div className="relative z-10 flex flex-col justify-between h-full p-8">
              ...
              <div className="absolute inset-6 z-0 overflow-hidden pointer-events-none rounded-3xl print:opacity-[0.15]">
                <div className="relative w-full h-full">
                  {/* React Logo - Kiri Atas */}
                  <div className="absolute -top-8 -left-8 -rotate-12 opacity-15">
                    <svg className="w-24 h-24 text-blue-400" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className="absolute -bottom-10 -right-8 -rotate-10 opacity-15">
                    <svg className="w-22 h-22 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {/* Code Snippet 4 - Dekat Docker */}
                  <pre className="absolute font-mono text-xs leading-relaxed text-cyan-500 bottom-12 right-20 rotate-6 whitespace-pre opacity-30">
                    {`docker run -p 3000:3000 app`}
                  </pre>

                  {/* Code Snippet 5 - Tengah */}
                  <pre className="absolute font-mono text-sm leading-relaxed text-orange-500 top-[45%] left-[38%] rotate-3 whitespace-pre opacity-25">
                    {`const data = await\n  fetch('/api/users')`}
                  </pre>
                </div>
              </div>
