...
export function EditCategoryDialog({ open, onOpenChange, category, onEdit }: EditCategoryDialogProps) {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Ubah informasi kategori buku.</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            {category.bookCount > 0 && (
              <div className="col-span-4 text-sm text-amber-600 bg-amber-50 p-3 rounded-md">
                <p>
                  Kategori ini memiliki {category.bookCount} buku terkait. Perubahan akan memengaruhi semua buku
                  tersebut.
                </p>
              </div>
            )}
