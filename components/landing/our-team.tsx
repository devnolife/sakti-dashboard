...
const OurTeam: React.FC = () => {
  ...
  return (
    <section id="team" className="relative py-16 bg-gradient-to-tl from-white via-peach-50/20 to-lavender-50/30 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 overflow-hidden" ref={ref}>
      {/* Ultra Modern Background Elements */}
      <div className="absolute rounded-full top-12 left-12 w-48 h-48 bg-gradient-to-br from-peach-100/30 to-secondary/12 blur-3xl animate-pulse" />
      <div className="absolute rounded-full bottom-12 right-12 w-64 h-64 bg-gradient-to-tr from-lavender-100/25 to-secondary-alt/15 blur-3xl animate-pulse delay-1500" />
